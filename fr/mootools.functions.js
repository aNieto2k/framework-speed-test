var functions = {
	...
	dieziocho: function(){
		$('page').getElements('a').each(function(a) {
			a.getParent().setStyle("border", "1px red solid");
		});
	}
}